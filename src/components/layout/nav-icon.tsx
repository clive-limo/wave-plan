...
const ICON_PATHS: Record<string, string> = {
  ...
  settings: "M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42",
};

export function NavIcon({ name, size = 18 }: NavIconProps) {
  // Compass has a polygon, handle separately
  if (name === "compass") {
    return (
